  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="font-sans-serif  text-center">
        <p>
          This is a text summariser project meant to help lawyers, students, or anyone interested in law understand lengthy legal documents.
        </p>
        <p>
          We built the text summariser by training 3 different transformers models - T5, Pegasus, GPT.
        </p>
      </div>
      <div>
        <Link href="/models">
